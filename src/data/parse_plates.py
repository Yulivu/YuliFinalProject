...
"""
Processing PB2002 plate boundary data
"""
...
def process_plate_boundaries():
    """Process plate boundary data into CSV format"""
    ...
    # Convert boundary data to DataFrame format
    rows = []
...
def process_plates():
    """Process plate polygon data into CSV format"""
                ...
                if line.strip() and not line.startswith('#'):
                    ...
                    if len(parts) >= 4:
                        ...
                        try:
                            ...
                            print(f"Error parsing pole data for {plate_id}: {e}")
    ...
    # Convert plate data to DataFrame format
    rows = []
...
def process_poles():
    """Process plate pole data into CSV format"""
    ...
    with open(poles_file, 'r') as f:
        for line in f:
            ...
            if ref_start is not None:
                # Extract plate code and numerical data only
                ...
                if len(parts) >= 4:
                    try:
                        ...
                        print(f"Pole data parsing error: {e}, line: {line}")
    ...
    if poles:
        ...
        print("No pole data found")
        return None


def main():
    """Main function"""
    print("Starting plate data processing...")

    # Process plate boundary data
    process_plate_boundaries()

    # Process plate polygon data
    process_plates()

    # Process plate pole data
    process_poles()

    print("Plate data processing complete!")
